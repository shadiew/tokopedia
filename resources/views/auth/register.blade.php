...
@section('title', 'Daftar - Toko Digital Download')
@section('description', 'Daftar akun baru untuk mengakses produk digital berkualitas.')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="role" class="form-label">
                                        <i class="fas fa-users me-1"></i> Tipe Akun
                                    </label>
